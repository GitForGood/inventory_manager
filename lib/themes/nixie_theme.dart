...
class NixieTubeTheme {
  ...
  // ... (keep all existing methods: lightTheme, darkTheme)
  ...
  static ThemeData get highContrastLightTheme {
    return ThemeData(
      ...
      colorScheme: ColorScheme.light(
        ...
        onSurface: hcTextDark,
        onBackground: hcTextDark,
        outline: hcTextDark,
      ),
      scaffoldBackgroundColor: hcBackgroundLight,
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: const TextStyle(
          fontSize: 22,
          fontWeight: FontWeight.w700, // Bolder for HC
          color: hcTextDark,
        ),
        iconTheme: const IconThemeData(color: hcTextDark, size: iconSizeMedium),
      ),

      // Card theme
      cardTheme: CardThemeData(
        color: hcSurfaceLight,
        elevation: elevationMedium,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(radiusMd),
          side: const BorderSide(color: hcTextDark, width: hcBorderWidth),
        ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          backgroundColor: hcPrimaryColor,
          foregroundColor: hcTextDark,
          minimumSize: const Size(64, buttonHeightLarge), // Larger for HC
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: hcTextDark, width: hcBorderWidth),
        ),
      ...
      listTileTheme: ListTileThemeData(
        ...
        tileColor: hcSurfaceLight,
        shape: RoundedRectangleBorder(
          side: const BorderSide(color: hcTextDark, width: 1),
        ),
      ),

      // Bottom navigation bar
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        backgroundColor: hcBackgroundLight,
        selectedItemColor: hcPrimaryColor,
        unselectedItemColor: hcTextDark,
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      // Divider theme
      dividerTheme: const DividerThemeData(space: spaceMd, thickness: 1),
    );
  }
